...
def main():
    ...
    # get n42 files
    background_n42_files = get_n42_paths("Background_RAW")
    calibration_n42_files = get_n42_paths("Energy_Cal_RAW")
    open_pit_mine_n42_files = get_n42_paths("Open_Pit_Mine_RAW")

    # print(background_n42_files)
